...
var makeL2 = function (expr) {
    ...
    throw new Error("Failed pattern match at CompileLambda2 (line 303, column 15 - line 305, column 97): " + [ v.constructor.name ]);
};
...
var makeL2Defs = function (expr) {
    ...
    throw new Error("Failed pattern match at CompileLambda2 (line 308, column 19 - line 310, column 97): " + [ v.constructor.name ]);
};
export {
    makeTypesL2,
    makeTypesL2Defs,
